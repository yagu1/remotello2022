...
#    def __init__(self, local_ip, local_port, imperial=False, command_timeout=.3, tello_ip='192.168.10.1', tello_cmd_port=8889, tello_info_port=8890, tello_video_port=11111):
    def __init__(self, imperial=False, command_timeout=.3, tello_ip='192.168.10.1', tello_cmd_port=8889, tello_info_port=8890, tello_video_port=11111):
        """
        ...
        :param tello_cmd_port (int): Tello port.
        """
        ...
        #self.socket_cmd.bind((local_ip, local_port))
